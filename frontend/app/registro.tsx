...
export default function RegistroScreen() {
  ...
  const handleRegistro = async () => {
    ...
    try {
      if (!API_URL) {
        throw new Error("Falta configurar EXPO_PUBLIC_API_URL en el .env");
      }

      console.log("📡 Intentando registrar en:", `${API_URL}/api/usuarios`);
      ...
      if (!contentType?.includes("application/json")) {
        throw new Error(
          `El servidor devolvió HTML en lugar de JSON. Status: ${response.status}. ` +
      ...
      router.replace({
        pathname: "/bienvenida",
        params: { nombre: nombre.trim(), codigo: codigo.trim() },
      });
    ...
    >
      ...
      >
        ...
        <View style={styles.formCard}>
          ...
          {/* Contraseña — CORREGIDO: sin duplicados, con props estables */}
          <View style={styles.inputGroup}>
            ...
            <TextInput
              ...
              // 🔑 Props clave para evitar el comportamiento "forzado":
          ...
          <View style={styles.inputGroup}>
            <Text style={styles.inputLabel}>
              Equipo <Text style={styles.optional}>(opcional)</Text>
            </Text>
            <TextInput
